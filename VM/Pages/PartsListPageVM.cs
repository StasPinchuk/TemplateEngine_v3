...
namespace TemplateEngine_v3.VM.Pages
{
    public class PartsListPageVM : BaseNotifyPropertyChanged
    {
        ...
        public PartsListPageVM(ITechnologiesManager technologiesManager, INodeManager nodeManager, Frame nodePage)
        {
        ...
        private void SetPageCollection()
        {
            ...
            else
            {
                ...
                UpdatePage(Title: "Детали", required: isAssembly, typeofPage: typeof(PartsListPage), PackIconKind.Cube, new object[] { _technologiesManager, _nodeManager });
            }
        ...
        private void InitializePages(bool isAssembly, bool needParamsAndTech)
        {
            ...
            PageCollection.Add(new PageModel("Основная информация", typeof(MainNodePage), true, PackIconKind.NoteText, new object[] { _nodeManager, SetPageCollection }));
            ...
            if (isAssembly)
            {
                PageCollection.Add(new PageModel("Детали", typeof(PartsListPage), PackIconKind.Cube, new object[] { _technologiesManager, _nodeManager }));
            }
        }
