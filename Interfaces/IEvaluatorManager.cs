...
namespace TemplateEngine_v3.Interfaces
{
    ...
    public interface IEvaluatorManager
    {
        ...
        ObservableCollection<ConditionEvaluator> AllTemplateParameters { get; set; }
        ObservableCollection<string> TemplateMarkings { get; set; }
        ...
        void SetAllTemplateParameters(ref TemplateRelations relations);
        /// <summary>
        ...
        List<ConditionEvaluator> GetNodeParameters(ObservableCollection<Node> nodes);
        /// <summary>
