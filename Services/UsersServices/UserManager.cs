...
namespace TemplateEngine_v3.Services.UsersServices
{
    ...
    public class UserManager
    {
        ...
        public List<User> GetAllUsers() => _allUsersManager.GetAllUsers();
        ...
        public ObservableCollection<User> GetFilteredAllUsersList() => _allUsersManager.GetFilteredUsersList(_currentUser, new()/*GetAlloweUsers()*/);
